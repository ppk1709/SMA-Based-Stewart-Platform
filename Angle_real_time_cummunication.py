...
arduino = serial.Serial(port='COM3', baudrate=9600, timeout=.1)  # Adjust 'COM3' to your Arduino's port
...
MARKER_SIZE = 0.005  # in meters (50 mm)q
...
while True:
    ...
    if marker_corners:
        ...
        if all(a is not None for a in [a1, a2, a3]):
            ...
            arduino.write(f"{angle_x},{angle_y},{angle_z}\n".encode())
